...
class CSVImportDialog(QDialog):
    """
    A dialog for selecting DuahauCSV File import options.
    """
...
class OWCSVFileImport(OWUrlDropBase):
    name = "DuahauCSV File Import"
    description = "Import a data table from a CSV formatted file."
    icon = "icons/CSVFile.svg"
    priority = 11
    category = "Duahau"
    keywords = "DuahauCSV File import, file, load, read, open, csv"
